# Prospect Transactions (Pop-Up)

Source: https://rmxhelp.rentmanager.com/Topics/Express/CSH/Prospect-Transactions.htm

This pop-up allows you to view and manage the transactions linked to the currently selected prospect. This includes adding and deleting charges, processing non-sufficient funds (NSF) payments, refunding electronic payments, clearing the allocations of payments, and so on.
 ...
 To access the View Transactions pop-up, go to arrow_forward Rental Info arrow_forward General arrow_forward Prospects and select a prospect from the list. On the Transactions tile, click .
 ...
 The system-generated details that provide context for the transaction.
 ...
 If you delete a charge that has payments allocated toward it, those payments are automatically applied to other open charges. If there are no open charges on the account, the payment is automatically applied when a charge is posted.
 ...
 Remove the current allocation(s) of a payment. This allows received money to be used to pay current or future charges on the account.
 ...
 Only on payment line items, you can select this option to open the Payment Receipt Export Options pop-up, and select the format in which the receipt should be exported.
