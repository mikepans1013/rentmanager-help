# Utility Tenant Consumption (Report)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Reports/Utility-Tenant-Consumption.htm

The Utility Tenant Consumption report displays a list of utility consumption and the charges applied to tenants for the consumption. You can use this report to quickly compare consumption rates between multiple tenants or for the same tenant across a period of time. This can help you look for irregularities in utility consumption rates or charges.
 ...
 Additionally, on the Reports tab, you must have access to Utility Tenant Consumption .

 For more information, refer to Control User Access .

 To view the Utility Tenant Consumption report, do the following:

 -
 Go to arrow_forward Services arrow_forward Metered Utilities arrow_forward Utility Tenant Consumption .
The Reports: Utility Tenant Consumption page displays.
 ...
 Exclude Records without Readings
 ...
 The Short Name of the meter type assigned to the utility associated with the consumption.
