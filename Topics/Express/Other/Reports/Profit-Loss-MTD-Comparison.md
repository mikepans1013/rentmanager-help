# Profit & Loss MTD Comparison (Report)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Reports/Profit-Loss-MTD-Comparison.htm

The Profit & Loss MTD Comparison report displays income and expense general ledger (GL) accounts for selected properties across two date ranges: one the user selects, and one that covers the last month in the date range. This P&L report displays financial activity across a specified time frame, and compares it to the financial activity of the last month to the date of the specified time frame. This gives you a side-by-side comparison of an entire activity range and a snapshot of activity from the last month in the date range. For this reason, this report is best generated when selecting the current date as the end of the date range.
 ...
 Additionally, on the Reports tab, you must have access to Profit & Loss MTD Comparison .

 For more information, refer to Control User Access .

 To view the Profit & Loss MTD Comparison report, do the following:

 -
 Go to arrow_forward Financial Statements arrow_forward Profit & Loss arrow_forward Profit & Loss MTD Comparison .
The Reports: Profit & Loss MTD Comparison page displays.
 ...
 This section of the report displays ending income account balances for all property transaction activity that occurred during the specified Date Range and, in a separate column, the last month in the Date Range . Income accounts are grouped together by type and provide subtotals for each grouping.

 Expense

 This section of the report displays ending expense account balances for all property transaction activity that occurred during the specified Date Range and, in a separate column, the last month in the Date Range . Expense accounts are grouped together by type and provide subtotals for each grouping.
 ...
 The name and number for income and expense GL accounts that have transaction activity in the Date Range .

 Period 1

 The balance for the income and expense GL accounts during the last month of the Date Range .

 Period 2

 The balance for the income and expense GL accounts that had activity within the entire Date Range .

 Net Income Summary Subreport

 This section of the report displays the totals of all income account balances and all expense account balances at the end of the Date Range and the last month of the Date Range , and subtracts the expense from the income to provide the net income for both time frames.
