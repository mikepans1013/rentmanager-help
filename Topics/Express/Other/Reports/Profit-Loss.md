...
Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Reports/Profit-Loss.htm

The Profit & Loss report displays income and expense general ledger (GL) accounts for selected properties or owners across a date range. This P&L report also displays the net income to track the financial impact of the selected properties.
 ...
 Additionally, on the Reports tab, you must have access to Profit & Loss .

 For more information, refer to Control User Access .

 To view the Profit & Loss report, do the following:

 -
 Go to arrow_forward Financial Statements arrow_forward Profit & Loss arrow_forward Profit & Loss .
The Reports: Profit & Loss page displays.
 ...
 Check to add a column in the report that displays the line item's portion of total income for the selected properties or ownerships.
 ...
 If the Restrict by owner contract dates report option is checked and the selected Date Range begins before and/or ends after the active owner contract, the report header displays only the dates where the active owner contract and the Date Range overlap. Filtered results display an asterisk (*) after the Date Range .

 Income

 This section of the report displays ending income account balances for all property transaction activity that occurred during the Date Range . Income accounts are grouped together by type and provide subtotals for each grouping.

 Expense

 This section of the report displays ending expense account balances for all property transaction activity that occurred during the Date Range . Expense accounts are grouped together by type and provide subtotals for each grouping.

 Net Income Summary

 This section of the report displays the net income for the selected properties (calculated by subtracting the total expenses from the total income).
 ...
 The total of each income and expense GL account that had activity within the Date Range .
