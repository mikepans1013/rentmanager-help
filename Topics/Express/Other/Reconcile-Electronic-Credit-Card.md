# Electronic Credit Card Reconciliation

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Reconcile-Electronic-Credit-Card.htm
...
A credit card reconciliation is an essential business process that involves comparing your internal financial records in Rent Manager to the financial records provided by your credit card provider in the real world. This ensures that your accounting records are correct and can help you identify any unusual or missing transactions caused by fraud or accounting errors.
 ...
 Electronic credit card reconciliation is a tool that allows you to import your credit card statement into Rent Manager , and it automatically matches transactions on that statement with the related transactions in your database. This provides a side-by-side look at the transactions that impacted your real-world credit card and the transactions entered in Rent Manager on the same page. Using this tool reduces the risk of missing data due to switching back and forth between Rent Manager and a paper or digital statement; everything you need to perform a reconciliation is in one place.
 ...
 Step 1: Prepare the Credit Card Statement Import File

 Credit card statements must be in either a .CSV or .QIF format to be imported into Rent Manager . If you're unable to download your credit card activity in the correct format, you can ask your provider to send you a copy of your statement in one of these file formats.
...
The Import File pop-up displays.
 ...
 -
 Click to select the credit card statement file from your computer and click Import .
The transactions from the credit card statement display in the Imported Transactions section. Any matching transactions are automatically checked and marked as Matched based on the Amount and the closest Date .
 ...
 If there are multiple potential transaction matches, the Reference is also used to determine automatic matches.
