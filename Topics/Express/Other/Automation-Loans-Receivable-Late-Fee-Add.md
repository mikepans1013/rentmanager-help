...
You can use this Task Automation to save time managing loans receivable late fees and to reduce errors from manual entry. You can create a variety of loan late fee automations to meet the needs of each of your properties. For example, if you only charge late fees on rent payments at one of your properties, you can create a loan late fee automation that only runs when rent payments are late.
 ...
 -
 Go to   arrow_forward   Administration , then go to Automation arrow_forward Task Automation arrow_forward Loans Receivable Late Fees .
The Loan Late Fee Automation Schedules page displays.
 ...
 This is not necessarily the first date that the schedule executes. The options configured in the Schedule Options section on the Loan Late Fee Automation Schedule Details pop-up determine the first run date.
 ...
 Use this value to adjust the day on which Rent Manager examines if a tenant is considered delinquent. This is valuable when you want to determine tenant delinquency as of a date before the Run Day .
 ...
 -
 Click Save .
The loan late fee automation schedule is added to Rent Manager .
