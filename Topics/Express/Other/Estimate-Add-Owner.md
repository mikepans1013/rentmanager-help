# Add an Owner Estimate

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Estimate-Add-Owner.htm
...
Estimates allow you to record the anticipated parts and labor needed to complete a project, itemize the costs, and provide a total amount due, including any markups and/or taxes you add. Estimates can also be linked to an invoice, service issue, and/or purchase order. On an estimate's details page, you can add or edit estimate information, link the estimate to other entities, add inventory items, manage history/note items, or delete existing estimates.
 ...
 For example, you can create estimates for owners to gauge the cost of updating units at their property so they can confirm if the scope of work is in their budget and allow them to see where they can add or remove costs to accomplish their needs.

 More Information

 This topic covers how to create an estimate for owners. For information on how to create an estimate for tenants and prospects, refer to Add a Tenant or Prospect Estimate .
...
The Estimates page displays.
 ...
 -
 Click the drop-down arrow next to   Add Estimate and select Add Owner Estimate .
The Add Estimate pop-up displays.
 ...
 The property established as the property management company in your database.

 Owner

 The tenant or prospect account receiving the estimate. Click the drop-down arrow next to the field name to change the selection from Owner to Tenant .

 To

 The default address of the owner account receiving the estimate.
 ...
 The property that is receiving the product(s) or service(s) on this line item.

 Unit

 If applicable, the unit that is receiving the product(s) or service(s) on this line item. If there is no specific unit associated with the line item, leave this column blank.
