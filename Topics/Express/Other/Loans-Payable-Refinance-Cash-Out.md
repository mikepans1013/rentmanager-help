# Loans Payable Cash-Out Refinance

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Loans-Payable-Refinance-Cash-Out.htm

When you refinance a loan, you can record the updated loan information so that Rent Manager accurately calculates your monthly interest and principal payments under the new loan terms. If you need to replace an existing loan with a new cash-out loan agreement (where cash is received by using some of the equity of the previous loan), you can use the Refinance option to change the loan's equity, amount, interest rate, and term. This way, your Rent Manager records and amortization calculations match the real-world status of your loan.
 ...
 This process is for the Cash-Out refinance option. For information on the Cash-In and Rate-and-Term refinance options, refer to Loans Payable Rate-and-Term Refinance and Loans Payable Cash-In Refinance .
...
The loan's details page displays.
 ...
 -
 In the Refinance Type drop-down, select Cash-Out .
 ...
 In this section, enter the New Loan's Total Principal Amount , which is the total dollar amount of the remaining principal. In the Cash Received field, enter the dollar amount you received for the cash-out refinance. This is the amount, minus interest, that you are expected to pay back by the Maturity Date . The principal amount can include additional financed costs. The amount in this field must match the sum of the current loan's remaining principal, cash received, and any additional financed costs.
