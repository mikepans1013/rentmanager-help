# Import STR Guest Prospects

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Importing/STR-Guest-Prospects.htm
...
The importing tool allows you to pull large amounts of data into Rent Manager at one time via a comma-separated values (CSV) file or other file type that uses supported delimiters. The file is first prepared outside Rent Manager , using a program such as Microsoft Excel or Notepad, which contains rows of data representing the information that matches to designated Rent Manager fields. This greatly reduces the amount of time spent on data entry, especially when first setting up your Rent Manager database, or during routine additions that require a lot of new data, such as acquiring a new property.
 ...
 When importing short-term rental (STR) guest prospects, you can add STR guests as new prospect accounts in Rent Manager along with their reservations.

 More Information

 This importing tool allows you to import guests only as prospects. To import guests as tenant accounts, refer to Import STR Guests for more information.
 ...
 Data in your import file should be organized with each row as a separate entity and each column containing information relevant to that entity. For example, an import of guest prospect data is displayed with each row representing a different guest prospect and each column representing information about that guest prospect.

 Required Fields

 In order to import STR guest prospects, some fields are required to have a value entered in the data file.
 ...
 You can import values into any Rent Manager guest prospect field, including user defined fields (UDFs). As long as your import file meets the field requirements above, you can include as many or as few additional fields of your choice.

 The following fields can be added as columns to import STR guest prospect information:
 ...
 The annual net income of the prospect.
 ...
 The city as listed on the prospect's details page in the Addresses tile.
 ...
 The first name of the prospect if importing the prospect's first and last names in separate columns.
 ...
 The last name of the prospect if importing the prospect's first and last names in separate columns.
 ...
 The name of a user who has the Sales Rep/Leasing Agent option checked on the user account to determine who is responsible for this prospect.
 ...
 The maximum dollar amount this prospect would be willing to pay in rent.
 ...
 The minimum dollar amount this prospect would be willing to pay in rent.

 Num of People

 The total number of people to stay in the unit, including the prospect.

 Number of Adults

 The number of adults associated with the prospect's reservation.

 Number of Children

 The number of children associated with the prospect's reservation.

 Number of Pets

 The number of pets associated with the prospect's reservation.
 ...
 The city as listed on the prospect's View Contacts pop-up in the Addresses section.

 Occupant Default Address Type

 One of the existing address types to be the default address type for a the contact included on the prospect account.
 ...
 The postal code as listed on the prospect's View Contacts pop-up in the Addresses section.

 Occupant State

 The state as listed on the prospect's View Contacts pop-up in the Addresses section.

 Occupant Street

 The street as listed on the prospect's View Contacts pop-up in the Addresses section.

 Occupant Street2

 If applicable, the second line of the street address as listed on the prospect's View Contacts pop-up in the Addresses section.
 ...
 One of the pet types to categorize the prospect's pet. For more information, refer to Pet Types (Page) .
 ...
 The postal or zip code as listed on the prospect's View Contacts pop-up in the Addresses section.
 ...
 Any additional information about the guest to display on that prospect's account.
 ...
 The specific model name of the guest's RV or vehicle.
 ...
 The total amount of the security deposit held for the prospect.
 ...
 The state as listed on the prospect's details page in the Addresses tile.

 Street

 The street as listed on the prospect's details page in the Addresses tile.

 Street 2

 If applicable, the second line of the street address as listed on the prospect's details page in the Addresses tile.
 ...
 Any prospect-type user defined fields (UDFs) can be added as their own column.
 ...
 To import STR guest prospects, do the following:

 -
 Go to arrow_forward Administration , then go to Import arrow_forward Import Records arrow_forward Import STR Guest Prospects .
The Import STR Guest Prospects Settings pop-up displays.
 ...
 -
 In the Default Values section, select the Property for which to import guest prospect information. Then, click Next .
The pop-up closes and the Import STR Guest Prospects page displays.
