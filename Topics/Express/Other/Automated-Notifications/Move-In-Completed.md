# Move In Completed (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/Move-In-Completed.htm

The Move In Completed automated notification can be configured to send an email or text message to users, property managers, leasing agents, or other external recipients when a prospect account is converted to a tenant account through the Move In wizard. This makes sending reminders, status updates, and communication about events an automatic process to streamline workflows for your business.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select Move In Completed .
The Automated Notification: Move In Completed page displays.
...
The setup's details display.
 ...
 Include the manager of the property where the move in was completed. Email notifications are sent to the email address entered on the property's details page in the Email field. Text notifications are sent to the phone number marked as Default on the property's details page.
