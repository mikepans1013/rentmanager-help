# Application Started, Not Completed (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/Application-Started-Not-Completed.htm

The Application Started, Not Completed automated notification can be configured to send an email or text message to property managers, other Rent Manager users, or applicants after a prospect begins an Apply Now application or sub-application, but has not yet submitted it. This can be used to prompt users to follow up with the applicant or notify prospects that their application needs to be completed.

 Related Preferences

 In order to utilize this notification, you must have Apply Now enabled in system web preferences. For more information, refer to Tenant Web Access Apply Now General (System Web Preferences) .
 ...
 You can create multiple configurations so that recipients for different properties can receive alerts. For example, you may wish to notify property managers at five intervals when an application has not been submitted, but alert prospects at only two intervals. Each configuration displays in the Notification Setups list on the left of the page.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select Application Started, Not Completed .
The Automated Notification: Application Started, Not Completed page displays.
...
If you are adding a new setup, the Notification Type pop-up displays.
 ...
 Creates a notification setup that can be sent to the prospect who has not submitted their application.
 ...
 The number of days that pass without the prospect modifying their application when the notification should be sent. For example, if you would like the notification to be sent one week after the application was last updated, enter 7 .
 ...
 If the selected setup is under Notify Applicant , you can configure this notification setup to be sent to the applicant who has not yet submitted their application.
 ...
 Include the prospect who has not submitted their application. This option can be configured to send only email notifications.
 ...
 This field displays only if the selected setup is under Notify Applicant .
