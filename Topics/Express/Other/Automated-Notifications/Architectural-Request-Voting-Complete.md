# Architectural Request Voting Complete (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/Architectural-Request-Voting-Complete.htm

The Architectural Request Voting Complete automated notification can be configured to send an email to property managers, other Rent Manager users, or external recipients after the board or committee has finished voting on an architectural request.
 ...
 You can create multiple configurations so that recipients for different properties can receive alerts. For example, you may wish to alert only certain users when an architectural request vote is complete at one property, but also notify the property manager at another property. Each configuration displays in the Notification Setups list on the left of the page.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select Architectural Request Voting Complete .
The Automated Notification: Architectural Request Voting Complete page displays.
...
The setup's details display.
 ...
 Include the manager of the association-type property linked to the architectural request that was voted on. Email notifications are sent to the email address entered on the property's details page in the Email field. Text notifications are sent to the phone number marked as Default on the property's details page.
