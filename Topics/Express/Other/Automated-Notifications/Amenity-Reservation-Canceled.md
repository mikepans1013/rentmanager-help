# Amenity Reservation Canceled (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/Amenity-Reservation-Canceled.htm

The Amenity Reservation Canceled automated notification can be configured to send an email or text message to property managers, other Rent Manager users, tenants, or external recipients when a reservable amenity request submitted via Tenant Web Access (TWA) is canceled by the submitting tenant. This can be used to alert users that a reservation time slot has been made available or send confirmation of the cancellation to the tenant.
 ...
 You can create multiple configurations so that recipients for different properties can receive alerts. For example, you may wish to alert property managers and front office staff when an amenity reservation is canceled at one property, but alert only property managers for another property. Each configuration displays in the Notification Setups list on the left of the page.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select Amenity Reservation Canceled .
The Automated Notification: Amenity Reservation Canceled page displays.
