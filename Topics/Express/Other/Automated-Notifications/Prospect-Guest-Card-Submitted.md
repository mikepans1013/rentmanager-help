# Prospect Guest Card Submitted (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/Prospect-Guest-Card-Submitted.htm

The Prospect Guest Card Submitted automated notification can be configured to send an email or text message to property managers, other Rent Manager users, prospects, or external recipients after a prospect submits a guest card. This can be used to prompt users to review the guest card, inform property managers of interested prospects, or thank prospects for their submission.
 ...
 You can create multiple configurations so that recipients for different properties can receive alerts. For example, you may wish to tailor the message sent to prospects depending on the property they contacted. Each configuration displays in the Notification Setups list on the left of the page.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select Prospect Guest Card Submitted .
The Automated Notification: Prospect Guest Card Submitted page displays.
...
If you are adding a new setup, the Notification Type pop-up displays.
 ...
 Creates a notification setup that can be sent to the prospect who submitted the guest card.
 ...
 Each prospect-type guest card template that should generate alerts when a guest card is submitted. To include all current and future prospect-type guest cards in the notification, check *** <All Templates> .
 ...
 Include the manager of the property linked to the submitted guest card. Email notifications are sent to the email address entered on the property's details page in the Email field. Text notifications are sent to the phone number marked as Default on the property's details page.
 ...
 If the selected setup is under Notify Guest , you can configure this notification setup to be sent to the prospect who submitted the guest card.
