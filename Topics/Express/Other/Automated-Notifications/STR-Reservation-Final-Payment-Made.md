# STR Reservation Final Payment Made (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/STR-Reservation-Final-Payment-Made.htm

The STR Reservation Final Payment Made automated notification can be configured to send an email or text message to guests when the final short term rental (STR) reservation payment is made.
 ...
 You can create multiple configurations so that recipients for different properties can receive alerts. For example, you may wish to use distinct verbiage for RV park payments and campground payments. Each configuration displays in the Notification Setups list on the left of the page.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select STR Reservation Final Payment Made .
The Automated Notification: STR Reservation Final Payment Made page displays.
...
The setup's details display.
 ...
 The next step is to determine whether the STR guest should receive the notification by Email , Text , or Email and Text .
