# Owner Prospect Not Contacted (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/Owner-Prospect-Not-Contacted.htm

The Owner Prospect Not Contacted automated notification can be configured to send an email or text message to sales reps, users, property managers, leasing agents, or external recipients as the length of time since an owner prospect was last contacted increases. An owner prospect's last contact date is based on the most recent Email , Call , or Visit history/note item on their account's History/Notes tile. This can be used to make sure sales reps follow up on their leads.
 ...
 You can create multiple configurations so that recipients for different roles can receive alerts. For example, you may wish to notify sales reps after two days without contact, but wait to notify property managers after five days without contact so they can follow up with the rep. Each configuration displays in the Notification Setups list on the left of the page.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select Owner Prospect Not Contacted .
The Automated Notification: Owner Prospect Not Contacted page displays.
...
The setup's details display.
 ...
 -
 In the Filters tile, select the number of days that should pass since the owner prospect was contacted before a notification is sent. The last contact date is determined by the call, email, or visit history/note item on the account with the most recent Start Date . For example, if you would like the notification to be sent when the owner prospect has not been contacted for five days, enter 5 .

 More Information

 Call history/note items must have Spoke with owner prospect checked to be considered when determining last contact date.
 ...
 Include the user selected on the owner prospect's details page in the Sales Representative field.
