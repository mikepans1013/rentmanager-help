# OWA Webuser Locked Out (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/OWA-Webuser-Locked-Out.htm

The OWA Webuser Locked Out automated notification can be configured to send an email or text message to selected recipients when an owner's Owner Web Access (OWA) web user account is locked out due to exceeding the number of incorrect password attempts established in system web preferences.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select OWA Webuser Locked Out .
The Automated Notification: OWA Webuser Locked Out page displays.
