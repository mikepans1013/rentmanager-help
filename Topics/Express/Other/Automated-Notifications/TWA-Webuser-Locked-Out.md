# TWA Webuser Locked Out (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/TWA-Webuser-Locked-Out.htm

The TWA Webuser Locked Out automated notification can be configured to send an email or text message to selected recipients when an tenant's Tenant Web Access (TWA) web user account is locked out due to exceeding the number of incorrect password attempts established in system web preferences.

 This can bypass the need for owners to contact property managers by automatically alerting a Rent Manager user of the lockout so that they can unlock the account or contact an administrator to unlock it.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select TWA Webuser Locked Out .
The Automated Notification: TWA Webuser Locked Out page displays.
...
The setup's details display.
 ...
 Include the manager of the property linked to the tenant account that was locked out. Email notifications are sent to the email address entered on the property's details page in the Email field. Text notifications are sent to the phone number marked as Default on the property's details page.
