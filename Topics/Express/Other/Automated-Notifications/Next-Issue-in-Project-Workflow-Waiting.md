# Next Issue in Project Workflow Waiting (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/Next-Issue-in-Project-Workflow-Waiting.htm

The Next Issue in Project Workflow Waiting automated notification can be configured to send an email or text message to service technicians, other Rent Manager users, or external recipients when the next issue in a workflow project is ready to be completed. This can be used to keep certain users up to date on the progress of a workflow project as it advances.

 This notification is sent only for projects with the option Steps must be completed in order enabled.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select Next Issue in Project Workflow Waiting .
The Automated Notification: Next Issue in Project Workflow Waiting page displays.
...
The setup's details display.
 ...
 Include the user assigned to the service issue that is awaiting completion.
