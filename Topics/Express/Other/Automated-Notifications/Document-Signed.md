# Document Signed (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/Document-Signed.htm

The Document Signed automated notification can be configured to send an email or text message to property managers, other Rent Manager users, or external recipients after a signable document recipient successfully signs a document and submits it back to you for final approval. This can be used to notify landlords or property managers that a signed lease is ready for review and final signatures.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select Document Signed .
The Automated Notification: Document Signed page displays.
...
The setup's details display.
 ...
 Include the manager of the property linked to the account that signed a document. Email notifications are sent to the email address entered on the property's details page in the Email field. Text notifications are sent to the phone number marked as Default on the property's details page.
