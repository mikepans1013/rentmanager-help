# Tenant Self Inspection Awaiting Review (Automated Notification)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Automated-Notifications/Tenant-Self-Inspection-Awaiting-Review.htm

The Tenant Self Inspection Awaiting Review automated notification can be configured to send an email and/or text message to property managers, other Rent Manager users, or external recipients when a tenant has submitted a self-inspection for their unit and needs to be reviewed by a user. This notification can help property managers address any reported issues that need to be resolved when the tenant moves in and cross-referenced when refunding security deposits.
 ...
 You can create multiple configurations so that recipients for different properties can receive alerts. For example, you may wish to notify property managers about pending self inspections for all properties, but notify front office staff only for residential properties. Each configuration displays in the Notification Setups list on the left of the page.
 ...
 -
 Go to arrow_forward Administration , then go to Automation arrow_forward General arrow_forward Automated Notifications and select Tenant Self Inspection Awaiting Review .
The Automated Notification: Tenant Self Inspection Awaiting Review page displays.
...
The setup's details display.
 ...
 Include the manager of the property linked to the tenant who submitted a self-inspection. Email notifications are sent to the email address entered on the property's details page in the Email field. Text notifications are sent to the phone number marked as Default on the property's details page.
