# Next Hard Close Date Function (Script)

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Scripts/Function-Next-Hard-Close-Date.htm

This function displays the accounting close date for the current period.
 ...
 Displays the accounting close date associated with accounts receivable transactions.
 ...
 Displays the accounting close date for the current period for the selected property.

 [Property().NextHardCloseDate("AP")]

 Displays the accounting close date set for accounts payable transactions for the current period for the selected property. The property must have Split Accounting Close for AR, AP, Journals/Adjustments selected in system preferences.
