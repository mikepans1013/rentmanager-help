# Loans Payable Rate-and-Term Refinance

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Loans-Payable-Refinance-Rate-Variables.htm

When you refinance a loan, you can record the updated loan information so that Rent Manager accurately calculates your monthly interest and principal payments under the new loan terms. If your loan refinance is a rate-and-term refinance, you can update the interest rate, the term (or duration) of the loan, or both. You can also record additional costs such as escrow, insurance, and closing costs. After you set up a loans payable refinance, Rent Manager continues to track information about outstanding loan payments and loan transactions.
 ...
 This process is for the Rate-and-Term refinance option. For information on the Cash-In and Cash-Out refinance options, refer to Loans Payable Cash-In Refinance and Loans Payable Cash-Out Refinance .
 ...
 To set up a rate-and-term refinance in Rent Manager , do the following:
...
The loan's details page displays.
 ...
 -
 In the Refinance Type drop-down, select Rate-and-Term .
 ...
 In this section, enter the New Loan's Total Principal Amount , which is the total dollar amount of the remaining principal. This is the amount, minus interest, that you are expected to pay back by the Maturity Date . The principal amount can include additional financed costs. The amount in this field must match the sum of the current loan's remaining principal and any additional financed costs.
 ...
 To record closing costs, check Record cash to close transaction and enter the following information:
 ...
 For each closing expense you need to record, click Add Item . Then, select a GL Account and enter an Amount for each line item.
