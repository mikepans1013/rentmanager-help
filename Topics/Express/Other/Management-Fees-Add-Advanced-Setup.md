# Add an Advanced Management Fee Setup

Source: https://rmxhelp.rentmanager.com/Topics/Express/Other/Management-Fees-Add-Advanced-Setup.htm

The Add Management Fees Setup pop-up enables you create an advanced management fee setup that you can use to collect a specified percentage of income-based general ledger accounts, and optionally set that percentage as pass-through.
...
The Fees Setup pop-up displays.
 ...
 -
 In the Active Start Date and Active End Date fields, enter or select the dates the new advanced management fee selections begins and ends. To post fees per individual unit, select Post Per Unit .
 ...
 Step 4: Add Chart Account Transfers
